        ...
        this.articles = [
            {
                ...
                excerpt: 'Подробное сравнение методов интеграции 1С с внешними системами. REST API, SOAP, файловый обмен, COM-соединения и прямой доступ к БД — выбираем оптимальный способ.',
                readTime: '25 мин',
                tags: ['1С интеграция', 'REST API', 'SOAP', 'COM соединения']
            }
        ];
